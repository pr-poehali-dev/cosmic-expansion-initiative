  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <TrendingUp
          className="absolute text-primary/20 animate-float"
          style={{ top: "25%", right: "18%", animationDelay: "2s" }}
          size={35}
        />
        <Sparkles
          className="absolute text-primary/20 animate-float"
      ...
      <div className="container mx-auto text-center max-w-5xl relative z-10">
        ...
        <p className="text-xl sm:text-2xl text-muted-foreground mb-10 max-w-3xl mx-auto animate-fade-in-up animate-delay-100 leading-relaxed">
          Курс повышения квалификации по технологиям и методам продвижения частного специалиста-психолога. Научитесь привлекать клиентов и строить личный бренд.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in-up animate-delay-200 mb-12">
          ...
          <Button
            size="lg"
            variant="outline"
            className="border-2 border-primary/30 text-foreground hover:bg-primary/5 hover:border-primary font-semibold px-8 py-6 text-lg bg-transparent"
            asChild
          >
